...
public class GlobalExceptionHandler extends ResponseEntityExceptionHandler {
    ...
    public ErrorResponse handleException(Exception e) {
        log.debug(e.getMessage(), e);
        return new ErrorResponse(e.getMessage(), WebtoonErrorCode.DEFAULT);
    }
    ...
    protected ResponseEntity<Object> handleMethodArgumentNotValid(MethodArgumentNotValidException ex, HttpHeaders headers, HttpStatusCode status, WebRequest request) {
        var errorResponse = new ErrorResponse(ex.getMessage(), WebtoonErrorCode.DEFAULT);
    ...
    protected ResponseEntity<Object> createResponseEntity(Object body, HttpHeaders headers, HttpStatusCode statusCode, WebRequest request) {
        ...
        var errorResponse = new ErrorResponse(message, WebtoonErrorCode.DEFAULT);
